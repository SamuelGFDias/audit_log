...
{
    private static readonly DiagnosticDescriptor CascadeNonSoftDeleteDescriptor = new(
        id: "SGSD001",
        title: "Cascade skipped for non-soft-delete dependent",
        messageFormat: "'{0}' does not implement ISoftDeleteEntity and will not be cascaded during soft-delete of '{1}'",
        category: "SoftDeleteGenerator",
        ...
        foreach (var fk in entity.ReferencingFks)
        {
            ...
            if (!fk.DependentIsSoftDelete)
            {
                context.ReportDiagnostic(Diagnostic.Create(
                    CascadeNonSoftDeleteDescriptor,
                    Location.None,
                    fk.DependentEntityName,
                    entity.Name));
            }
